...
const Hero = () =>{
    ...
    function sendToMonterya(){
      ...
      // Redirect User to Monterya
    }
  
    return (
        <div className="relative min-h-screen w-full">
			<Image src={"/rabbit_nobg.png"} alt="Rabbit Image" layout="fill" objectFit="cover" />
    ...
    <div className="grid min-h-screen px-8">
      <div className="container relative z-10 my-auto mx-auto grid place-items-center text-center">
        ...
        <p
          className="text-white text-lg lg:text-xl mt-4 mb-12 w-full md:max-w-full lg:max-w-2xl"
        >
          Join us for the adventure that is coming this year - The Monterya Official 2024!
        </p>
        <div className="flex items-center gap-4">
          <a onClick={sendToMonterya} href="#_" className="relative inline-flex items-center justify-center px-10 py-4 overflow-hidden font-mono font-medium tracking-tighter text-white bg-blue-500 rounded-lg group">
